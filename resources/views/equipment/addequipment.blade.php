            ...
            <nav class="nav navbar navbar-expand-xl navbar-light iq-navbar">
                <div class="container-fluid navbar-inner">
                    <a href="dashboard" class="navbar-brand">
                        ...
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/ir-logo.png" height="50" width="50"><h4 class="logo-title d-block d-xl-none">IR Clinic</h4>
                            </a>
                    ...
                    <div class="d-flex align-items-center justify-content-between product-offcanvas">
                        <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Equipment</small>
                        </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="new-user-info">
                        <form id="validation" method="POST" action="/addequipment">
                            @csrf
                            <div class="row">
                            ...
                            <div class="form-group col-md-12">
                                <label class="form-label" for="add1">stocks:</label>
                                <input type="text" name="stocks" class="form-control" id="stocks" placeholder="stocks">
                            </div>
