                ...
                <div class="container-fluid navbar-inner">
                    ...
                    <div class="d-flex align-items-center justify-content-between product-offcanvas">
                        <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">Equipments Data</small>
                        </div>
            ...
            <table id="datatable" class="table " data-toggle="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$equipment->stocks}}</td>
                        <td>{{$equipment->status}}</td>
                        
                        <td>
                            <div class="d-flex justify-content-evenly">
                                
                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="/addequipment" role="button">
                                    <span class="btn-inner">
                                ...
                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="/deleteeq/{{$equipment->id}}" role="button">
                                    <span class="btn-inner">
                                        <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
