                ...
                <div class="container-fluid navbar-inner">
                    ...
                    <div class="d-flex align-items-center justify-content-between product-offcanvas">
                        <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                            <small class="mb-0 text-capitalize">operations Data</small>
                        </div>
                ...
                <!-- Nav Header Component Start -->
                    <div class="iq-navbar-header " style="height: 215px;">
                        ...
                        <div class="iq-header-img">
                            <img src="<?php echo URL('/'); ?>/assets/images/dashboard/top-header.png" alt="header" class="theme-color-default-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="<?php echo URL('/'); ?>/assets/images/dashboard/top-header1.png" alt="header" class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="<?php echo URL('/'); ?>/assets/images/dashboard/top-header2.png" alt="header" class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="<?php echo URL('/'); ?>/assets/images/dashboard/top-header3.png" alt="header" class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="<?php echo URL('/'); ?>/assets/images/dashboard/top-header4.png" alt="header" class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                            <img src="<?php echo URL('/'); ?>/assets/images/dashboard/top-header5.png" alt="header" class="theme-color-pink-img img-fluid w-100 h-100 animated-scaleX" loading="lazy">
                        </div>
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">New operation Information</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="new-user-info">
                        <form id="validation" method="POST" action="/addoperation">
                            @csrf
                            <div class="row">
                            <div class="form-group col-md-12">
                                <label class="form-label" for="operation">operation:</label>
                                <input type="text" name="operation" class="form-control" id="operation" placeholder="operation">
                            </div>
                            <div class="form-group col-md-12">
                                <label class="form-label" for="lname">hospital:</label>
                                <input type="text" name="hospital" class="form-control" id="hospital" placeholder="hospital">
                            </div>
                            <div class="form-group col-md-12">
                                <label class="form-label" for="add2">Patient:</label>
                                <input type="text" name="patient" class="form-control" id="patient" placeholder="patient">
                            </div>
                            <div class="form-group col-md-12">
                                <label class="form-label" for="add1">Charge:</label>
                                <input type="text" name="charge" class="form-control" id="charge" placeholder="charge">
                            </div>
                            
                            <div class="form-group col-md-12">
                                <label class="form-label" for="add2">date:</label>
                            ...
                            <button type="submit" class="btn btn-primary">Add Operation Details</button>
                        </form>
                    </div>
                </div>
            </div>
