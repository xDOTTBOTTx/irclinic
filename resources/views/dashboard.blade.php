                ...
                <!--Nav Start-->
                    ...
                    <div class="container-fluid navbar-inner">
                        <a href="dashboard" class="navbar-brand">
                                                            ...
                                                            <!--logo End-->         <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/ir-logo.png" height="50" width="50"><h4 class="logo-title d-block d-xl-none">IR Clinic</h4>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
                                ...
                                <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <img src="<?php echo URL('/'); ?>/assets/images/avatars/01.png" alt="User-Profile" class="theme-color-default-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                                    <img src="<?php echo URL('/'); ?>/assets/images/avatars/avtar_1.png" alt="User-Profile" class="theme-color-purple-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                                    <img src="<?php echo URL('/'); ?>/assets/images/avatars/avtar_2.png" alt="User-Profile" class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                                    <img src="<?php echo URL('/'); ?>/assets/images/avatars/avtar_3.png" alt="User-Profile" class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                                    <img src="<?php echo URL('/'); ?>/assets/images/avatars/avtar_4.png" alt="User-Profile" class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                                    <img src="<?php echo URL('/'); ?>/assets/images/avatars/avtar_5.png" alt="User-Profile" class="theme-color-pink-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/hospital.png" class="me-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <h6 class="mb-0">Total Hospital</h6>
                    </div>
                    
                </div>
                <div class="d-flex align-items-center">
                    <div>
                        <h3>{{$hospitalcounts}}</h3>
                        <small class="text-success">Total Available Hospitals</small>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/equipment.png" class="me-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">

                        <h6 class="mb-0 ms-2">Total Equipments</h6>
                    </div>
                    
                </div>
                <div class="d-flex align-items-center">
                    <div>
                        <h3>{{$equipmentcounts}}</h3>
                        <small class="text-success">Total Available Equipments</small>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/doctor.png" class="me-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <h6 class="mb-0 ms-2">Total Doctors</h6>
                    </div>
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h3>{{$doctorcounts}} </h3>
                        <small class="text-success">Total Available Doctors</small>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/operation.jpg" class="me-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">

                        <h6 class="mb-0 ms-2">Total Operation</h6>
                    </div>
                    
                </div>
                <div class="d-flex align-items-center">
                    <div>
                        <h3>{{$operationcounts}}</h3>
                        <small class="text-success">Total Operations Done</small>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/operation.jpg" class="me-2" width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">  
                        <h6 class="mb-0 ms-2">Today's Operation</h6>
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/live.gif" height="40" width="60">
                    </div>
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h3>{{$operationcounts}}</h3>
                        <small class="text-danger">Today's Operations To be done</small>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    <div class="d-flex align-items-center">
                        ...
                        <h6 class="mb-0 ms-2">Equipment used by today</h6>
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/live.gif" height="40" width="60">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h3>{{$equipmenttoday}}</h3>
                        <small class="text-danger">Equipments Used Today</small>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-2 align-items-center">
                    <div class="d-flex align-items-center">
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/money.png" height="40" width="40">

                        <h6 class="mb-0 ms-2">Total Collection</h6>
                        <img src="<?php echo URL('/'); ?>/assets/images/hospitalimages/live.gif" height="40" width="60">
                ...
                <div class="d-flex align-items-center">
                    <div>
                        <h3>{{$collection}}</h3>
                        <small class="text-danger">Total Collection Till Today</small>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-evenly">
                                                ...
                                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="addoperation" role="button">
                                                    <span class="btn-inner">
                                                ...
                                                <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="/deleteop/{{$operation->id}}" role="button">
                                                    <span class="btn-inner">
                                                        <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
