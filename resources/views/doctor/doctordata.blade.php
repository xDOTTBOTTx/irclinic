                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-evenly">
                                    ...
                                    <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="/adddoctor" role="button">
                                        <span class="btn-inner">
                                    ...
                                    <a class="btn btn-primary btn-icon btn-sm rounded-pill ms-2" href="/deletedo/{{ $doctor->id }}" role="button">
                                        <span class="btn-inner">
                                            <svg class="icon-32" width="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
