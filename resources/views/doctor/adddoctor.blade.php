                        ...
                        <div class="container-fluid navbar-inner">
                            ...
                            <div class="d-flex align-items-center justify-content-between product-offcanvas">
                                <div class="breadcrumb-title border-end me-3 pe-3 d-none d-xl-block">
                                    <small class="mb-0 text-capitalize">Doctors Data</small>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="new-user-info">
                                <form id="validation" method="POST" action="/adddoctor">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="add2">Mobile NO:</label>
                                        <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Mobile">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="add1">specialities:</label>
                                        <input type="text" name="specialities" class="form-control" id="specialities" placeholder="specialities">
                                    </div>
                                    
                                    <div class="form-group col-md-12">
                                        <label class="form-label" for="add2">Status:</label>
